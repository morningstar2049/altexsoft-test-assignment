...
const Board = () => {
  ...
  const handleClick = (id, player) => {
    ...
    setFightersData(prevData => {
      // console.log(prevData)
      return {...prevData, [player]:{ id,avatar: fighters[id-1].avatar, name: fighters[id-1].name, health : fighters[id-1].health, attack:fighters[id-1].attack, defense: fighters[id-1].defense} }
    })
  };
